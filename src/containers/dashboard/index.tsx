...
import artworkAngle2 from "../../assets/images/turtle-angle-2.png";
    ...
    <div className="min-h-screen bg-gradient-to-b from-obsidian-500 via-obsidian-400 to-obsidian-500">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-pearl-200 text-lg mb-8 max-w-lg mx-auto lg:mx-0">
                ...
                this extraordinary work and support inclusive creativity.
              </p>
              ...
              {authData ? (
                ...
                <p className="text-pearl-300">Connect to continue</p>
              )}
            </motion.div>
      ...
      <section className="py-24 px-8">
        <div className="max-w-6xl mx-auto">
          ...
          >
            {[
              { label: "Medium", value: "Mixed", suffix: "Media" },
              {
                label: "Technique",
                value: "Digital + Traditional",
                suffix: "",
              },
              { label: "Minimum Investment", value: "$150", suffix: "" },
            ].map((stat, i) => (
              <motion.div
                key={i}
              ...
              >
                ...
                <p className="text-4xl font-light text-white">
                  {stat.value}
                  <span className="text-2xl text-pearl-400">
                    {" "}
                    {stat.suffix}
                  </span>
                </p>
