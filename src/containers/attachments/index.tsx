...
const iconMap: Record<string, any> = {
  ...
  "Artist Statement": FileCheck,
  "Creation Process": Globe,
  "Artwork Documentation": FileText,
};

const ArtworkDocumentation = () => {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-pearl-200 text-lg max-w-2xl mx-auto">
              Every aspect of "The Masterpiece" has been documented and
              verified. Explore the creation process, artist's vision, and
              authenticity certificates before making your investment.
            </p>
          </motion.div>
                      ...
                      <div className="flex items-start gap-6">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-luxury-gold-500 text-sm mb-3">
                            {attachment.files?.length || 0} document(s)
                          </p>
                          <p className="text-pearl-300 text-sm mb-4">
                            {attachment.description ||
                              "Official documentation for The Masterpiece"}
                          </p>
          ...
          >
            ...
            >
              ...
              <p className="text-pearl-200 mb-8 max-w-lg mx-auto">
                After reviewing the documentation, purchase your fraction of
                "The Masterpiece" and become part of this extraordinary
                artwork's story.
              </p>
              <motion.button
...
export default ArtworkDocumentation;
