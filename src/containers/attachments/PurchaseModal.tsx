...
import { ArrowRight, Check, Palette, X } from "lucide-react";
            ...
            >
              ...
              <div className="p-8">
                {step === "select" && (
                  ...
                  >
                    <div className="mb-6">
                      <h3 className="text-xl text-white mb-2">{artworkName}</h3>
                      <p className="text-pearl-300 text-sm">
                        Own a fraction of this unique artwork and support the
                        artist
                      </p>
                    </div>
                    ...
                    <div className="bg-obsidian-300/30 rounded-xl p-6 mb-8">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className="text-white">${pricePerFraction}</span>
                      </div>
                      <div className="flex justify-between items-center mb-2">
                ...
                {step === "confirm" && (
                  ...
                  >
                    <div className="text-center mb-8">
                      <Palette className="w-16 h-16 text-luxury-gold-500 mx-auto mb-4" />
                    ...
                    <div className="bg-obsidian-300/30 rounded-xl p-6 mb-8">
                      ...
                      <ul className="space-y-2 text-sm text-pearl-400">
                        <li className="flex items-start gap-2">
                          ...
                          <span>Own a fraction of this unique artwork</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <Check className="w-4 h-4 text-luxury-gold-500 mt-0.5" />
                          <span>Support the artist and ArTech Collective</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <Check className="w-4 h-4 text-luxury-gold-500 mt-0.5" />
                          <span>Help fund future art programs</span>
                        </li>
                      </ul>
                    </div>
                ...
                {step === "processing" && (
                  ...
                  >
                    ...
                    <p className="text-pearl-300">Please wait...</p>
                  </motion.div>
                )}
